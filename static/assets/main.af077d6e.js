!(function(e) {
    ...
    !(function(t, n) {
      ...
      var E =
        ...
        (function(e) {
          ...
          try {
            L.apply((N = H.call(w.childNodes)), w.childNodes),
          ...
          function we(e, t, n, r, o, i) {
            return (
              ...
              se(function(i, a, s, u) {
                ...
                } else (m = be(m === a ? m.splice(h, m.length) : m)), o ? o(null, a, m, u) : L.apply(a, m);
              })
            );
          }
          function Te(e) {
          ...
          return (
            ...
            (a = ie.tokenize = function(e, t) {
              ...
              for (s = e, u = [], l = r.preFilter; s; ) {
                ...
                (o = F.exec(s)) &&
                  ((n = o.shift()),
                  i.push({ value: n, type: o[0].replace(_, " ") }),
                  (s = s.slice(n.length))),
                r.filter))
                  !(o = V[a].exec(s)) ||
                    (l[a] && !(o = l[a](o))) ||
              ...
              if (((n = n || []), 1 === d.length)) {
                ...
                for (
                  ...
                  if (
                    ...
                    if ((u.splice(i, 1), !(e = o.length && me(u))))
          ...
          function(e, t) {
            C.fn[e] = function(n, r) {
              ...
              return (
                ...
                this.length > 1 &&
                  (M[e] || C.uniqueSort(o), P.test(e) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
            ...
            var t = [
              ...
              o = {
                ...
                then: function(e, r, o) {
                  ...
                  return C.Deferred(function(n) {
                    t[0][3].add(a(0, n, y(o) ? o : $, n.notifyWith)),
      ...
      function Ie(e, t) {
        ...
        if (1 === t.nodeType) {
          if (
            K.hasData(e) &&
            ((i = K.access(e)), (a = K.set(t, i)), (l = i.events))
          )
      ...
      function Re(e, t, n, r) {
        ...
        if (
          ...
          for (s = (a = C.map(ve(o, "script"), Pe)).length; f < p; f++)
            (u = o),
              f !== d &&
      ...
      function $e(e, t, n) {
        for (var r, o = t ? C.filter(t, e) : e, i = 0; null != (r = o[i]); i++)
          n || 1 !== r.nodeType || C.cleanData(ve(r)),
            r.parentNode &&
              (n && C.contains(r.ownerDocument, r) && me(ve(r, "script")),
          ...
          ajax: function(e, t) {
            ...
            function S(e, t, a, s) {
              ...
              c ||
                ...
                (x = void 0),
                f &&
                  v.trigger(l ? "ajaxSuccess" : "ajaxError", [k, h, l ? p : d]),
                y.fireWith(g, [k, T]),
                f &&
      ...
      C.ajaxSetup({
        ...
        (m.createHTMLDocument = (((zt = a.implementation.createHTMLDocument("")
        ...
        C.each(["top", "left"], function(e, t) {
          C.cssHooks[t] = ze(m.pixelPosition, function(e, n) {
            if (n)
              return (n = Fe(e, t)), We.test(n) ? C(e).position()[t] + "px" : n;
          });
        }),
  ...
  function(e, t, n) {
    ...
    o()(document).ready(function() {
      const e = () => {
        ...
        o()(window).resize(function() {
          ...
          o()(".report-infographics .bar, .report mark").each(function() {
            var t = o()(this).offset().top + o()(this).height() / 2;
            t < o()(window).scrollTop() || t > o()(window).scrollTop() + e
              ? o()(this).addClass("sleep")
              : o()(this).removeClass("sleep");
          });
      };
      e(), window.addEventListener("scroll", e);
    });
    o()(document).ready(function() {
      o()(".js-scroll-link").click(function(e) {
        e.preventDefault();
        var t = -40;
        o()(o.a.attr(this, "href")).data("scroll-link-offset") &&
          (t += o()(o.a.attr(this, "href")).data("scroll-link-offset")),
          o()("html, body").animate(
            { scrollTop: o()(o.a.attr(this, "href")).offset().top + t },
            500
          );
      });
    });
    o()(document).ready(function() {
      let e, t, n, r, i, a, s;
      function u(t) {
        o()("body").removeClass(e),
          o()("body").addClass(t),
          localStorage.setItem("color-scheme", t),
          o()(".color-switch input:radio")
            .filter(`[value=${t}]`)
            .prop("checked", !0),
          o()(".palette").addClass("hidden"),
          o()(`.${t}-palette`).removeClass("hidden"),
          (e = t);
      }
      function l(e) {
        switch (e) {
          case "em":
            o()(".em-converter").removeClass("visible"),
              o()(".px").hide(),
              o()(".em").show();
            break;
          case "px":
            o()(".em-converter").addClass("visible"),
              o()(".px").show(),
              o()(".em").hide();
        }
        localStorage.setItem("global-units", e),
          o()(".units-selector input:radio")
            .filter(`[value=${e}]`)
            .prop("checked", !0),
          (n = e);
      }
      function c(e) {
        o()(".props").each(function() {
          let t = o()(this)
            .find(".base")
            .text()
            ? o()(this)
            ...
            o()(this)
              ...
              .each(function() {
                ...
                o()(this)
                  .find(".em")
                  .hasClass("base") || (n *= t);
                let r = Math.floor(n * e * 10) / 10;
                o()(this)
                  .find(".px")
                  .text(r);
              });
        }),
          localStorage.setItem("px-in-em", e),
          o()(".em-converter input").val(e),
          (r = e),
          o()(".units-selector-container").length &&
            o()("body").css("font-size", `${e}px`);
      }
      function f() {
        let e, t;
        if (o()(".units-selector-breakpoint").length) {
          let n = o()(".units-selector-breakpoint").offset().top;
          e = o()(window).scrollTop() - n;
          let r = o()(".color-switcher-breakpoint").offset().top;
          t = o()(window).scrollTop() - r;
        }
        e >= 0
          ? o()(".unit-control").removeClass("hidden")
          : o()(".unit-control").addClass("hidden"),
          t >= 0
            ? o()(".color-control").removeClass("hidden")
            : o()(".color-control").addClass("hidden");
      }
      f(),
        o()(window).scroll(f),
        o()(".orb__js-nav-close").click(function(e) {
          e.preventDefault(), o()(".orb__js-nav").removeClass("visible");
        }),
        o()(".orb__nav-hambourger").click(function(e) {
          e.preventDefault(),
            e.stopPropagation(),
            o()(".orb__js-nav").addClass("visible");
        }),
        o()(window).on("click", function(e) {
          o()(".orb__js-nav").removeClass("visible");
        }),
        o()(".orb__js-nav").click(function(e) {
          e.stopPropagation();
        }),
        u(
          (t = localStorage.getItem("color-scheme")
        ...
        o()(".color-switch input:radio")
          ...
          .prop("checked", !0),
        (e = t),
        o()(".color-switch input:radio").change(function() {
          u(o()(this).val());
        }),
        l(
          (a = localStorage.getItem("global-units")
            ? localStorage.getItem("global-units")
            : o()(
        ...
        o()(".units-selector input:radio")
          ...
          .prop("checked", !0),
        (n = a),
        o()(".units-selector input:radio").change(function() {
          l(o()(this).val());
        }),
        c(
          (s = localStorage.getItem("px-in-em")
            ? localStorage.getItem("px-in-em")
            : o()(".main-em-converter input").val())
        ),
        o()(".em-converter input").val(s),
        (r = s),
        (i = setInterval(function() {
          let e = o()(".main-em-converter input").val(),
            t = o()(".sidebar-em-converter input").val(),
            n = 0;
          e != r && (n = e), t != r && (n = t), n && c(n);
        }, 300));
    });
  }
]);
//# sourceMappingURL=main.af077d6e.js.map
